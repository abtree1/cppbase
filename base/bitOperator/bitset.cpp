...
int main(){
	//常规初始化方法
	stF::bitset<8> b1; // [0,0,0,0,0,0,0,0]
	stF::bitset<8> b2(42);	// [0,0,1,0,1,0,1,0]
	stF::bitset<8> b3(0xfff0); // [1,1,1,1,0,0,0,0]
	//用字符串初始化bitset
	string str = "110010";
	//后面两个参数为截取str操作，第一个是开始截取位置 第二个为截取长度
	stF::bitset<8> b4(str);		// [0,0,1,1,0,0,1,0] 相当于 "110010"
	stF::bitset<8> b5(str, 2);	// [0,0,0,0,0,0,1,0] 相当于 "0010"
	stF::bitset<8> b6(str, 4);	// [0,0,0,0,0,0,1,0] 相当于 "10"
	stF::bitset<8> b7(str, 2, 3); // [0,0,0,0,0,0,0,1] 相当于 "001"
	stF::bitset<8> b8(str, 0, 2); // [0,0,0,0,0,0,1,1] 相当于 "11"
	//赋值操作
