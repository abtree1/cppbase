...
//	std::string oristr = "akusdhuiasj;dkasl;dkas;lkdl;askdl;as";
//	std::string key = "12312312asr2";
//	int orilen = oristr.size();
//	int keylen = key.size();
//	hsha1.HMAC_SHA1((BYTE *)oristr.c_str(), orilen, (BYTE *)key.c_str(), keylen, digest);
//	std::string tmp_digest=base64Encode(digest,sizeof(digest));
//	std::cout << tmp_digest.c_str() << std::endl;
//	return 0;
//}
